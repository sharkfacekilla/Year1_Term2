...
public class CalculatorView extends JFrame {
    ...
    public void setProductValue(int solution) {
    ...
    void addProductListener(ActionListener listenForCalculateProduct) {
        calculateProduct.addActionListener(listenForCalculateProduct);
    }
